...
const Profile = () => {
	...
	const donatedDonationsInfo = useGetDonatedDonationsQuery();
	const receiverDonationsInfo = useGetReceivedDonationsQuery();
	...
	return (
		<>
			...
			{currentTab === "Donated" && (
				<ProfileDonations
					donations={donatedDonationsInfo.data?.donations}
					titleText="Donated Donations"
				/>
			)}
			{currentTab === "Received" && (
				<ProfileDonations
					donations={receiverDonationsInfo.data?.donations}
					titleText="Received Donations"
				/>
			)}
		</>
	);
