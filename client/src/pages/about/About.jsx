...
const aboutData = [
	...
	},
	{
		...
		description:
			"We are committed to promoting transparency, safety, and equity in everything we do. We promise to: Provide a safe, secure platform for donation donations and requests. Thoroughly vet all donated medications to ensure their safety and efficacy. Protect the privacy and personal information of our users. Work to reduce donation waste and promote sustainable healthcare practices. Empower individuals to take control of their health. By making these promises, we aim to build trust and accountability with our users, and to create a platform that truly makes a difference in people's lives.",
	},
];
