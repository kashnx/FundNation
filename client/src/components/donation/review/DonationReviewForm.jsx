...
import { useAddReviewMutation } from "../../../features/donations/reviewSlice";
import { useNavigate } from "react-router-dom";

const DonationReviewForm = ({ donationId }) => {
	...
	const onSubmit = (data, e) => {
		addReview({ ...data, donation: donationId, review: data.description })
			.unwrap()
			.then((response) => {
...
export default DonationReviewForm;
